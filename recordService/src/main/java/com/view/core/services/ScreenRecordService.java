...
public class ScreenRecordService extends Service implements Handler.Callback{
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public boolean stopRecord(String filePath) {
        if (!mIsRunning) {
            return false;
        }
        mIsRunning = false;
...
//        mRecordFilePath = null;
    ...
    private void setUpMediaRecorder() {
        ...
        Log.d("dddd", "setUpMediaRecorder: "+ mRecordFilePath+ ", "+ mRecordWidth+ ", "+ mRecordHeight);
